...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(_attrs)}><header><h2 class="text-lg font-medium text-gray-900">Informação do perfil</h2><p class="mt-1 text-sm text-gray-600"> Atualize as informações do seu perfil e email. </p></header><form class="mt-6 space-y-6"><div>`);
