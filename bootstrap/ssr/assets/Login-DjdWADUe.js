...
import { _ as _sfc_main$2 } from "./GuestLayout-ByJ3ND1Z.js";
      ...
      _push(ssrRenderComponent(_sfc_main$2, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<span class="ms-2 text-sm text-gray-600"${_scopeId}>Lembre-se de mim.</span></label></div><div class="flex items-center justify-end mt-4"${_scopeId}>`);
              ...
              createVNode("form", {
                ...
                createVNode("div", { class: "block mt-4" }, [
                  createVNode("label", { class: "flex items-center" }, [
                    ...
                    createVNode("span", { class: "ms-2 text-sm text-gray-600" }, "Lembre-se de mim.")
                  ])
                ]),
