...
import _sfc_main$3 from "./UpdatePasswordForm-qW_XAGaP.js";
import _sfc_main$2 from "./UpdateProfileInformationForm-DznnWUCI.js";
import { Head } from "@inertiajs/vue3";
import "./_plugin-vue_export-helper-1tPrXgE0.js";
import "./InputError-DzpKvWT9.js";
import "./TextInput-DFrpu0bn.js";
import "./PrimaryButton-DyGxzdH4.js";
const _sfc_main = {
  __name: "Edit",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="font-semibold text-xl text-gray-800 leading-tight"${_scopeId}> Perfil </h2>`);
          } else {
            return [
              createVNode("h2", { class: "font-semibold text-xl text-gray-800 leading-tight" }, " Perfil ")
            ];
          }
        }),
