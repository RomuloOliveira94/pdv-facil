    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(AdminLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_Head, { title: "Usuários" }, null, _parent2, _scopeId));
            _push2(`<div class="container mx-auto px-6 py-8"${_scopeId}><h1${_scopeId}>Pegou os users</h1></div>`);
          } else {
            return [
              createVNode(_component_Head, { title: "Usuários" }),
              createVNode("div", { class: "container mx-auto px-6 py-8" }, [
                createVNode("h1", null, "Pegou os users")
              ])
            ];
          }
        }),
