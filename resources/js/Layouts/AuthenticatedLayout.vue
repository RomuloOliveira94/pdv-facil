...
<template>
    <div>
        <div class="min-h-screen bg-gray-100">
                            ...
                            <button
                                @click="
                                    showingNavigationDropdown =
                                        !showingNavigationDropdown
                                "
                                class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-white focus:text-gray-500 transition duration-150 ease-in-out"
                            >
                                <svg
                                    class="h-6 w-6"
                                    stroke="currentColor"
            ...
            <!-- Page Heading -->
            <header class="bg-[#FFF6E6] shadow" v-if="$slots.header">
            ...
            <!-- Page Content -->
            <main>
                <div class="py-4 px-2 bg-[#FFF6E6]">
                    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 min-h-screen mb-16">
                        <slot />
                    </div>
                </div>
            </main>
